...
menu() {
    ...
    echo -e "#                   ${RED}------- Translated By: RARE -------${PLAIN}                 #"
    ...
    echo -e "  ${GREEN}4.${PLAIN}   Install V2ray-${BLUE}VMESS+WS+TLS${PLAIN}${RED}(recommend)${PLAIN}"
    ...
    echo -e "  ${GREEN}8.${PLAIN}   Install V2ray-${BLUE}VLESS+TCP+XTLS${PLAIN}${RED}(recommend)${PLAIN}"
